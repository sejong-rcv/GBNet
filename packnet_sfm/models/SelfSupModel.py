...
class SelfSupModel(SfmModel):
    ...
    def self_supervised_loss(self,depthnet, image, ref_images, inv_depths, poses,
        ...
        """
        return self._photometric_loss(depthnet,
    ...
    def forward(self, batch, return_logs=False, progress=0.0):
        ...
        if not self.training:
            ...
            self_sup_output = self.self_supervised_loss(self.depth_net,
    ...
    def forward_con(self, batch, return_logs=False, progress=0.0):
